package edu.matoleot.android.currentweek;
...
import edu.matoleot.android.currentweek.utils.DateUtils;
...
public class ResultActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setAudioDependingTheResult(boolean isTheResultCorrect) {
        mediaPlayer = MediaPlayer.create(this, isTheResultCorrect ? R.raw.aplausos : R.raw.cristal_roto);
